...
gridpoints <- read.csv(here("./data/spatial/lon_lat_dbem.txt"), header = FALSE)
...
write.csv(grid_final_area, here("./data/mpa/grid_all_mpas_b.csv"))
...
write.csv(grid_final, here("./data/mpa/grid_all_mpas.csv"))
```
...
grid_all_mpas <- read_csv("../data/mpa/grid_all_mpas.csv")
...
name <- paste0(here("data/mpa/mpa_index"),".txt")
