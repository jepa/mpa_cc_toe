...
```{r}
MPA1 <- read_sf("/Users/sarahroberts/Documents/ClimateOceanPlanning/R/mpa_cc_toe_old/Data/Spatial/WDPA_WDOECM_Jul2022_Public_marine_shp/WDPA_WDOECM_Jul2022_Public_marine_shp_0/WDPA_WDOECM_Jul2022_Public_marine_shp-polygons.shp")
#plot(MPA1)

MPA2 <- read_sf(here("/Users/sarahroberts/Documents/ClimateOceanPlanning/R/mpa_cc_toe_old/Data/Spatial/WDPA_WDOECM_Jul2022_Public_marine_shp/WDPA_WDOECM_Jul2022_Public_marine_shp_1/WDPA_WDOECM_Jul2022_Public_marine_shp-polygons.shp"))

MPA3 <- read_sf("/Users/sarahroberts/Documents/ClimateOceanPlanning/R/mpa_cc_toe_old/Data/Spatial/WDPA_WDOECM_Jul2022_Public_marine_shp/WDPA_WDOECM_Jul2022_Public_marine_shp_2/WDPA_WDOECM_Jul2022_Public_marine_shp-polygons.shp")
...
MPA <- MPA %>% sample_frac(.02)

MPA1 <- read_sf("/Users/sarahroberts/Documents/mpa_ubc_project/Data/Coastal_Marine_in27.shp")
#plot(MPA1)
MPA1 <- MPA1 %>% dplyr::filter(MARINE == 2)
```
...
intr <- intr %>% add_count(groups) %>% mutate("prop" = ((mpa_n/n)) + 1) #this is the total number of gridcells within one continuous MPA/total number of grid cells surrounding that MPA 
