...
if(Sys.info()[8] == "jepa88"){
  ...
  root_path <- "/Users/sarahroberts/Documents/ClimateOceanPlanning/R/mpa_cc_toe_old" # SARAH MAKE SURE THIS PATH MAKES SENSE
}
...
```{r}
MPA1 <- read_sf(paste0(root_path,"/data/spatial/WDPA_WDOECM_Jul2022_Public_marine_shp/WDPA_WDOECM_Jul2022_Public_marine_shp_0/WDPA_WDOECM_Jul2022_Public_marine_shp-polygons.shp"))
#plot(MPA1)

MPA2 <- read_sf(paste0(root_path,"/data/spatial/WDPA_WDOECM_Jul2022_Public_marine_shp/WDPA_WDOECM_Jul2022_Public_marine_shp_1/WDPA_WDOECM_Jul2022_Public_marine_shp-polygons.shp"))

MPA3 <- read_sf(paste0(root_path,"/data/spatial/WDPA_WDOECM_Jul2022_Public_marine_shp/WDPA_WDOECM_Jul2022_Public_marine_shp_2/WDPA_WDOECM_Jul2022_Public_marine_shp-polygons.shp"))
...
write.csv(grid_final_area, paste0(root_path,"/data/mpa/grid_all_mpas_b.csv"))
...
grid_all_mpas <- read_csv(paste0(root_path,"/data/mpa/grid_all_mpas.csv"))
...
name <- paste0(root_path,"data/mpa/mpa_index",".txt")
